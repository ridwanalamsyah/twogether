...
export function OfflineBanner() {
  ...
  return (
    <div className="sticky top-[calc(var(--sat)+76px)] z-30 mx-4 mt-2 flex items-center gap-2 rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-1.5 text-[11px] text-amber-700 dark:text-amber-300">
